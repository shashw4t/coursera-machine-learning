...
% y(k)
% cost function needs vectors with the 1s in the appropriate rows
...
% Not supposed to regularize bias terms
% so we skip the first column of these matrices
...
%back propagation for loop done 
